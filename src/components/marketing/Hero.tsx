...
export default function Hero() {
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 w-full text-center max-w-sm mx-auto flex flex-col items-center pb-6">
          ...
          <p 
            ...
            style={{ color: "#27272a" }}
          >
            Diseño, automatizaciones e infraestructura digital para tu negocio.
          </p>
        </div>
      ...
      <section className="hidden lg:flex relative min-h-screen items-center pt-28 pb-20 px-6 md:px-12 overflow-hidden bg-black">
